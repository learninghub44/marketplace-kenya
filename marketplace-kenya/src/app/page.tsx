  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-900">
      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-orange-950 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-12 lg:py-20 flex flex-col items-center gap-8 text-center lg:text-left lg:flex-row lg:items-start">
          <div className="text-white space-y-5 max-w-xl">
            ...
            <p className="text-gray-300 text-lg">Discover great deals and connect with genuine sellers across Kenya — electronics, fashion, vehicles, property and more.</p>
