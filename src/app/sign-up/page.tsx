...
export default function SignUpPage() {
  ...
  useEffect(() => {
    ...
    window.location.href = `https://${domain}/sign-up?redirect_url=${encodeURIComponent(window.location.origin + '/auth/callback')}`
  }, [isLoaded, isSignedIn])
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="text-center space-y-3">
        ...
        <p className="text-gray-500 text-sm">Redirecting to register…</p>
