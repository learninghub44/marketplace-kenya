...
import { ShoppingBag, Phone, Mail, MessageCircle, Shield, CheckCircle, Globe, CreditCard } from 'lucide-react'
    ...
    <footer className="bg-gray-900 dark:bg-gray-950 text-white mt-auto">
      <div className="container mx-auto px-4 py-10">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-sm">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-black text-lg">
                <span className="text-white">Sokoni</span><span className="text-orange-400"> Kenya</span>
              </span>
            </div>
            <p className="text-gray-400 text-xs leading-relaxed">
              Kenya's free marketplace for buyers and sellers. Buy, sell and connect securely nationwide.
            </p>
            <div className="flex gap-3 mt-4">
              <a href="https://wa.me/254701059192" target="_blank" rel="noopener noreferrer"
                className="bg-green-600 hover:bg-green-700 p-2 rounded-lg transition-colors" title="WhatsApp">
          ...
          {/* Support */}
          <div>
            <h4 className="font-bold mb-3 text-orange-400 text-sm uppercase tracking-wide">Support</h4>
            <ul className="space-y-2.5 text-gray-400 text-xs">
              <li><Link href="/support" className="hover:text-white transition-colors font-medium text-sm">Help Centre</Link></li>
